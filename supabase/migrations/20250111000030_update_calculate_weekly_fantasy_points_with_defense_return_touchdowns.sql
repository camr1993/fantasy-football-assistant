-- Update calculate_weekly_fantasy_points function to include defense_return_touchdowns
-- This adds the missing stat to the existing function
...
-- Add comment
COMMENT ON FUNCTION calculate_weekly_fantasy_points IS 'Calculates and updates weekly fantasy points for all players in a league using league-specific modifiers, including defense_return_touchdowns';
