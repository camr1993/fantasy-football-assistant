-- Create a function to calculate and store weekly fantasy points in league_calcs table
-- This function calculates points using league-specific modifiers and stores them in league_calcs
...
-- Add comment
COMMENT ON FUNCTION calculate_weekly_fantasy_points IS 'Calculates and updates weekly fantasy points for all players in a league using league-specific modifiers';
